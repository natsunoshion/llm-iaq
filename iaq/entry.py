...
from iaq.utils.parallel import auto_parallel
from iaq.quantize.pre_quant import run_awq, apply_awq
from iaq.quantize.quantizer import (
    pseudo_quantize_model_weight,
    real_quantize_model_weight,
)
from iaq.utils.lm_eval_adaptor import LMEvalAdaptor
from iaq.utils.utils import simple_dispatch_model
...
def build_model_and_enc(model_path):
    ...
    if vila_10_quant_mode:
        ...
        # Note: To avoid OOM after transformers 4.36.2
    ...
    if args.load_quant:  # directly load quantized weights
        ...
        if args.run_awq:
            ...
            if args.dump_awq:
                ...
                print("IAQ results saved at", args.dump_awq)

            exit(0)

        if args.load_awq:
            print("Loading pre-computed IAQ results from", args.load_awq)
